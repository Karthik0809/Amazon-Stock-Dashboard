...
with mlflow.start_run(run_name="Seq2SeqLSTM"):
    ...
    X_s2s, y_s2s = make_multi_sequences(nc, seq_len=SEQ_LEN, horizon=HORIZON)
    ...
    mlflow.log_metric("rmse", s2s_rmse)
    mlflow.log_metric("mape", s2s_mape)
    mlflow.log_metric("best_val_loss", best)
    mlflow.log_artifact('seq2seq_lstm.pth', artifact_path="models")
    ...
    mlflow.log_artifact('notebook_outputs/04_seq2seq_training.png', artifact_path="plots")
    plt.close()
